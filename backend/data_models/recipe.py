...
# same int4 upper bound reasoning as menu.py's category_id.
...
class Ingredient(Base):
    ...
    __table_args__ = (
        ...
        # shape User.username uses, so "Tomato" and "tomato" cannot
        # coexist as two rows.
...
class CreateRecipeIngredientRequest(BaseModel):
    ...
    # column exactly, same reasoning as CreateIngredientRequest's bounds.
