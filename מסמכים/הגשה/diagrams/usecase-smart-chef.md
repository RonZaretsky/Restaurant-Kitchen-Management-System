...
3. **פתיחת שיחת ייעוץ** *(טבח)* - דיאלוג חופשי עם השף החכם סביב הצעת מתכון. שתי הודעות
   במקביל באותה שיחה נדחות.
...
9. **הוספת כיוון חופשי** *(extend)* - הטבח יכול לצרף הנחיה בלשון חופשית, שאינה גוברת על
   מגבלת המלאי.
10. **עדכון המתכון שבהצעה** *(extend)* - ההחלטה אם הודעה מסוימת כוללת עדכון למתכון
    מתקבלת בכל הודעה מחדש, לא פעם אחת עבור השיחה כולה: הטבח יכול לשלוח הודעת ייעוץ בלבד
    ואז הודעה שמבקשת שינוי, באותה שיחה עצמה.
